...
from dungeon_game import Game, char_params, params_char, new_enemy
    ...
    while run:
        ...
        if menu_choice == 1:
            ...
            if name_choice != 3:  # продолжаем создавать персонажа, выбираем пол
                ...
                Game(name=char_name, params=char_params(char_choice)).save_new_game()
                if params_choice == 1:
                    pass
                    ...
                    draw.draw()
                    draw = Draw(canvas(pictures(22), pictures(5), pictures(23)), 7)
                    draw.draw()
                    ...
                    if statistic_choice == 1:
                        ...
                        while enemy:
                            ...
                            if enemy_choice is True:
                                cls()
                                draw = Draw(canvas(pictures(22), pictures(5), pictures(24)), 7)
                                draw.draw()
                                new_enemy_choice = Menu(1, 2, draw).check_choice()
